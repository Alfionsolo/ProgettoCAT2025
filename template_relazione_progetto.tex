...
\author{Panaroni Davide, Finocchiaro Alfio, Traini Francesco, Xhika Kleolin }
\date{Gennaio 2024}
...
Il progetto riguarda il controllo di una macchina motorizzata dotata di disco rotante (con elasticità di  coefficiente $k$) e motore elettrico che genera la coppia dei momenti in input ($C_M$). La dinamica del sistema è definita dall'equazione differenziale
%
...
\end{subequations}
%
dove $\theta(t)$ rappresenta l'angolo del disco e $\omega(t)$ la sua velocità angolare.
...
\begin{align}
	...
	\end{bmatrix} = \begin{bmatrix}
		\frac{17}{36}\pi \\
		0
	\end{bmatrix},  \quad u_e = \frac{85}{9}\pi.\label{eq:equilibirum_pair}
\end{align}
%
